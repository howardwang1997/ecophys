...
**2026-08-20 问题优先探索状态：** 原 v4 方法路线的 G0 FAIL 仍然有效。此后免费公开数据上的三条
真实干预候选也没有解锁新的 NCS 主线：电力调度候选在 T0 因不可识别/先验工作占位停止；永续合约
...
Liquity 关闭后新建的 Morpho allocator--IRM coupling 候选目前为 **AMBER，T0 数学编码通过**，详见
