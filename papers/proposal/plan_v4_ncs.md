...
13. **Aave A0 源码/恒等式已通过：** 当前候选效应类是单一 base-reserve liquidation-threshold
    ...
    account/action/response 行。唯一 sealed run 已在 protocol commit `fdb1dc414...` 完成：14 files、
    197,890 bytes、63 markers、12/12 gates，独立 raw-source replay 通过，summary SHA-256 为
    `355928afb19ab4b4a8f6de0b786986e9aa4542e1394a3acac7b14dc1ebbc85e9`。冻结 disclosure 把 197,858
    Unicode characters 误称 bytes，结果文档已勘误，不影响 hashes/markers/gates。Proposal 204 只能作
