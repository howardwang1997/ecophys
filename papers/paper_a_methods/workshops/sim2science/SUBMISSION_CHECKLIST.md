...
- [x] Ten learned checkpoints and 320 trajectories are complete and hash-verified.
- [x] Calibration gate file was serialized and hashed before any held-out trajectory existed.
- [x] `LEARNED_RESULTS.json`, result tier, manuscript numbers, and learned figure agree exactly.
...
- [x] `check_submission.py`, `pdfinfo`, `pdffonts`, and full visual page inspection pass.
- [x] Final PDF is under 50 MB and copied to `output/pdf/` with its SHA-256 recorded.
