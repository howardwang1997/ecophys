#!/usr/bin/env python3
"""Evaluate E1b only after exact R2 retention has been verified."""
...
def main() -> None:
    ...
    if retention_errors:
        raise RuntimeError("invalid AEMO E1b retention receipt: " + "; ".join(retention_errors))
    ...
    summary = summarize_bundle_confirmation(
        tables,
        observations,
        manifest,
        download,
