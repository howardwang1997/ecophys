...
Discovered 480 runs, 480 with eval, 11 rejected for numerical instability (469 counted in stats below).
...
| `attr_eurusd_ar1_s05_seed27` | aggregational_gaussianity=1700.9 (>|1000.0|) | 4/11 |
| `attr_eurusd_b3_k3_seed18` | aggregational_gaussianity=1081.0 (>|1000.0|) | 3/11 |
| `attr_eurusd_zumbach_dn_s10_seed25` | conditional_kurtosis=137.4 (>|100.0|) | 5/11 |
| `attr_eurusd_zumbach_dn_s10_seed3` | conditional_kurtosis=137.8 (>|100.0|) | 8/11 |

## Per-cell summary (stability filter applied)
| cell | n_seeds | mean n/11 | 95% CI | std | max | #(≥8) | rejected |
|---|---:|---:|---|---:|---:|---:|---:|
| `attr_eurusd_zumbach_dn_s10` | 28 | **5.36** | [4.86, 5.86] | 1.39 | 8 | 4 | 2 |
| `attr_btcusdt_b3_k3` | 29 | **5.10** | [4.62, 5.55] | 1.29 | 7 | 0 | 1 |
| `attr_eurusd_asymdrag_a06` | 30 | **5.10** | [4.57, 5.60] | 1.45 | 7 | 0 | 0 |
| `attr_btcusdt_asymdrag_a06` | 30 | **4.93** | [4.40, 5.43] | 1.46 | 7 | 0 | 0 |
| `attr_btcusdt_zumbach_dn_s10` | 27 | **4.81** | [4.26, 5.37] | 1.52 | 8 | 1 | 3 |
| `attr_eurusd_powerlaw_a15` | 30 | **4.80** | [4.27, 5.33] | 1.52 | 8 | 1 | 0 |
| `attr_btcusdt_powerlaw_a15` | 30 | **4.73** | [4.13, 5.33] | 1.70 | 8 | 1 | 0 |
| `attr_eurusd_memk_l095_s10` | 30 | **4.73** | [4.27, 5.23] | 1.36 | 8 | 1 | 0 |
| `attr_eurusd_ar1_s05` | 29 | **4.72** | [4.17, 5.28] | 1.53 | 8 | 1 | 1 |
...
| `attr_eurusd_baseline_v3` | 30 | **4.60** | [4.03, 5.17] | 1.61 | 8 | 1 | 0 |
| `attr_eurusd_b3_k3` | 29 | **4.52** | [4.00, 5.03] | 1.45 | 8 | 1 | 1 |
| `attr_btcusdt_ar1_s05` | 28 | **4.43** | [3.96, 4.89] | 1.23 | 7 | 0 | 2 |
| `attr_eurusd_levy_a17` | 30 | **4.33** | [3.90, 4.77] | 1.30 | 7 | 0 | 0 |
...
| `attr_eurusd_ar1_s05_seed8` | **8/11** |
| `attr_eurusd_b3_k3_seed14` | **8/11** |
| `attr_eurusd_baseline_v3_seed24` | **8/11** |
| `attr_eurusd_memk_l095_s10_seed4` | **8/11** |
| `attr_eurusd_powerlaw_a15_seed8` | **8/11** |
| `attr_eurusd_zumbach_dn_s10_seed0` | **8/11** |
| `attr_eurusd_zumbach_dn_s10_seed15` | **8/11** |
