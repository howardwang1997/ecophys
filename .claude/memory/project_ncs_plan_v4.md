...
- Hard gates: G0 novelty, G1 state/dynamics and four-arm causal confirmation, G2 cross-system method,
...
- Full all-gates planning envelope: roughly 3,800–10,100 V100-eq GPU-hours and 8,900–30,100 CPU core-hours.
