...
EcoMD is a differentiable, stateful, molecular-dynamics-style simulator whose positive model and real-market-physics routes failed their binding gates. Broad “first differentiable/Langevin market simulator” claims are ruled out by prior art. **Plan v5 (2026-08-12)** is the active feasibility iteration: build a mechanism-separated, multi-clock market world model with an exact exchange kernel, learned event-generating behavior, slower behavioral adaptation, explicit institutional interventions and sealed real-world evaluation. NMI is conditional on transferable AI-method evidence; Nature Computational Science is conditional on a replicated market-science result. Current compute is 2×V100 32 GB plus 1×RTX 2060 8 GB and may expand to more non-H20 GPU/CPU nodes. No H20 is used or assumed. Full plan: `papers/proposal/plan_v5_interventional_market_world.md`; lineage: `docs/research_lineage.md`. Plan v3 physics and Plan v4 invariant calibration remain historical gate records, not active claims.
