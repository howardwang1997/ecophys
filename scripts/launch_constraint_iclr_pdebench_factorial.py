"""Launch the frozen PDEBench factorial CUDA preflight or formal worker."""
...
CONFIG_NAME = "pdebench_advection_fno_factorial_20260901"


def build_factorial_command(root: Path, mode: str) -> list[str]:
    command = [
        sys.executable,
    ...
    overrides = {
        ...
        "output": (
            ...
            "factorial_preflight_20260901.jsonl"
        ),
        "checkpoint_dir": (
            "experiments/constraint_attribution_iclr/pdebench/"
            "factorial_preflight_checkpoints_20260901"
        ),
    }
...
def main() -> None:
    ...
    command = build_factorial_command(root, args.mode)
